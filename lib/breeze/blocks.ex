defmodule Breeze.Blocks do
  ...
  an optional `:color` (a terminal color index or RGB tuple). Colors default to
  terminal palette slots 6, 5, 2, 3, 4, and 1, cycling in series order. Set colors
  ...
  overrides the default terminal palette color described in `line_chart/1`.
  ...
  attr :mode, :atom, default: :grouped, values: [:grouped, :stacked]
  attr :max, :any, default: nil
  attr :class, :string, default: nil
  attr :style, :any, default: nil
  attr :rest, :global
  ...
  def bar_chart(assigns) do
    ...
    assigns =
      assign(assigns,
        content: content,
        class:
          merge_class("w-#{assigns.width} h-#{height} overflow-hidden", class_override(assigns))
      )
